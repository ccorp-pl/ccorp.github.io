const songs = [
    {
        title: 'Kac KILLER!',
        thumbnail: './assets/thumbnails/poster-1.png',
        path: './assets/songs/music-1.mp3',
        artist: 'DJ Bocian'
    },
    {
        title: 'Bocianowe Disco',
        thumbnail: './assets/thumbnails/poster-2.png',
        path: './assets/songs/music-2.mp3',
        artist: 'DJ Bocian'
    },
    {
        title: 'BocianoweLove',
        thumbnail: './assets/thumbnails/poster-3.png',
        path: './assets/songs/music-3.mp3',
        artist: 'DJ Bocian, DJ Maślak'
    },
    {
        title: 'Prawo Ulicy',
        thumbnail: './assets/thumbnails/poster-4.png',
        path: './assets/songs/music-4.mp3',
        artist: 'DJ Bocian'
    },
    {
        title: 'PGCWL',
        thumbnail: './assets/thumbnails/poster-5.png',
